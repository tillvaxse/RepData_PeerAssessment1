...
These formulas gives a mean and median of **`r mean_new`** and **`r median_new`** respectively.

These values differ greatly from the estimates from the first part of the assignment(**`r mean`** and **`r median`**). The impact of imputing the missing values is to have more data, hence to obtain a bigger mean and median value.
